      ...
      <div className="p-3 border-t border-sidebar-border">
        <ul className="space-y-1">
          ...
          <li>
            <button 
              disabled 
              className="w-full flex items-center gap-3 px-3 py-2.5 rounded-md text-sm text-sidebar-foreground/60 opacity-50 cursor-not-allowed transition-colors"
            >
