...
// Questões expandidas
$string['questiontype_multichoice'] = 'Multiple Choice Question';
$string['questiontype_shortanswer'] = 'Short Answer Question';
$string['questiontype_essay'] = 'Essay Question';
$string['questiontype_truefalse'] = 'True/False Question';
$string['questiontype_numerical'] = 'Numerical Question';
$string['questiontype_description'] = 'Description/Information';

$string['questions_created'] = 'Questions created successfully';
$string['questions_failed'] = 'Some questions failed to create';
$string['invalid_question_type'] = 'Invalid question type specified';
$string['question_category_created'] = 'Question category created automatically';
