...
class get_module_types extends external_api {
    ...
    public static function execute_parameters() {
        return new external_function_parameters([
            'courseid' => new external_value(PARAM_INT, 'Course ID to check permissions', VALUE_DEFAULT, 0),
            'filter' => new external_value(PARAM_ALPHA, 'Filter by type: "supported" for plugin supported types, "all" for all available', VALUE_DEFAULT, 'all')
        ]);
    }
